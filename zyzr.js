...
const jsname = '自由之刃'
const $ = Env(jsname)
let ck = ($.isNode() ? process.env.zycookie : $.getdata('zycookie')) || '13547889520#666666';
let ckArr = []
let sign = ($.isNode() ? process.env.zysigncookie : $.getdata('zysigncookie')) || '&eu-stamp=1658322731785&eu-sign=a251277cb3d0bede6dfa3a0188306e5d';
let envSplitor = ['@']
!(async () => {
